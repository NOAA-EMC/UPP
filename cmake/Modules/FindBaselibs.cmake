if (NOT DEFINED ENV{BASEDIR})
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL "pgc*" )
    string(REGEX MATCH "openmpi" OPENMPI ${MPI_Fortran_INCLUDE_PATH}) 
    if( OPENMPI MATCHES "openmpi" )
...
set (NETCDF_LIBRARIES CACHE INTERNAL "netcdf libs" )
set (NETCDF_INCLUDES CACHE INTERNAL "netcdf includes" )
