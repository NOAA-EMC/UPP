...
!
      include 'mpif.h'
      integer comdup,mype,npes,MPI_COMM_COMP,MPI_COMM_INTER
      integer, allocatable :: irank ( : )
      integer  INUMQ(*)
      logical yes
      character*4 get
!
       integer igroup_x,iworld_minus,igroup,iworld,iqserver, &
               iquilt_group,npes_mod
       integer i,j,jj,issl,iss,irlr,icc,kk,ierr,istaq,iendxx,ixx,   &
               istaxx,iendq,icolor
!-----------------------------------------------------------------------
!
!     INITIALIZE MPI
