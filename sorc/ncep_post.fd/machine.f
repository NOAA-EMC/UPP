...
!> @brief module: MACHINE_POST defines machine-dependent constants
      ...
      ,kind_phys(:,:) &     !< Integer parameter specifying the kind value for real numbers used in physics__?
      ,kind_rad(:,:) &      !< Integer parameter specifying the kind value for real numbers used in radiation calculations__?
