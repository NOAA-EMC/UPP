...
! dong for hgtsfc and pressfc
              if (trim(varname) .eq. "hgtsfc" .or. trim(varname) .eq. "pressfc" .or.        &
                  trim(varname(1:5)) .eq. "uhmax" .or. trim(varname(1:5)) .eq. "uhmin" .or. &
                  trim(varname(3:9)) .eq. "vvelmax" .or. trim(varname(1:7)) .eq. "maxvort" ) then
