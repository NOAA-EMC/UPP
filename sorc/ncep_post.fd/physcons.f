...
!  Primary constants
  ...
  real(kind=kind_phys),parameter:: con_cp      =1.0046e+3_kind_phys !< spec heat air at p           (J/kg/K)
  real(kind=kind_phys),parameter:: con_cv      =7.1760e+2_kind_phys !< spec heat air at v           (J/kg/K)
  ...
  real(kind=kind_phys),parameter:: con_psat    =6.1078e+2_kind_phys !< pres at H2O triple point     (Pa)  
