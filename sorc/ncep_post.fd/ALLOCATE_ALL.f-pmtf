...
! AQF
      ...
      allocate(pm25hp(im,jsta_2l:jend_2u,lm))
      allocate(pm25cl(im,jsta_2l:jend_2u,lm))
      allocate(pm25ec(im,jsta_2l:jend_2u,lm))
      allocate(pm25na(im,jsta_2l:jend_2u,lm))
      allocate(pm25mg(im,jsta_2l:jend_2u,lm))
      allocate(pm25k(im,jsta_2l:jend_2u,lm))
      allocate(pm25ca(im,jsta_2l:jend_2u,lm))
      allocate(pm25nh4(im,jsta_2l:jend_2u,lm))
      allocate(pm25no3(im,jsta_2l:jend_2u,lm))
      allocate(pm25oc(im,jsta_2l:jend_2u,lm))
      allocate(pm25om(im,jsta_2l:jend_2u,lm))
      allocate(pm25soil(im,jsta_2l:jend_2u,lm))
      allocate(pm25so4(im,jsta_2l:jend_2u,lm))
      allocate(pmtf(im,jsta_2l:jend_2u,lm))
      allocate(pm25unspec1(im,jsta_2l:jend_2u,lm))
      ...
      do l=1,lm
        do j=jsta_2l,jend_2u
          do i=1,im
             ...
             aclk(i,j,l)=spval
             acors(i,j,l)=spval
             acro_primary(i,j,l)=spval
             acrolein(i,j,l)=spval
             aeci(i,j,l)=spval
             aecj(i,j,l)=spval
             afej(i,j,l)=spval
             aglyj(i,j,l)=spval
             ...
             pm25oc(i,j,l)=spval
             pm25om(i,j,l)=spval
             pm25soil(i,j,l)=spval
             pm25so4(i,j,l)=spval
             pmtf(i,j,l)=spval
             pm25unspec1(i,j,l)=spval
          enddo
        enddo
      enddo
!
