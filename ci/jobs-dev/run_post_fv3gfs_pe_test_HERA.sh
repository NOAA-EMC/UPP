...
#SBATCH -o out.post.fv3gfs_pe_test
#SBATCH -e out.post.fv3gfs_pe_test
#SBATCH -J fv3gfs_pe_test
#SBATCH -t 00:30:00
...
export DATA=$rundir/fv3gfs_${startdate}_pe_test
export tmmark=tm00
...
if [ $err = "0" ] ; then
 ...
 export err1=$?
 if [ $err1 -eq 0 ] ; then
  msg="fv3gfs pe test: your new post executable generates bit-identical ${filein2} as the trunk"
  echo $msg
 else
  msg="fv3gfs pe test: your new post executable did not generate bit-identical ${filein2} as the trunk"
  echo $msg
 ...
 msg="fv3gfs pe test: post failed using your new post executable to generate ${filein2}"
