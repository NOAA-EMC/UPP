...
if [ $err = "0" ] ; then
 ...
 export err1=$?
 if [ $err1 -eq 0 ] ; then
  msg="hrrr test: your new post executable generates bit-identical ${filein2} as the trunk"
  echo $msg
 else
  msg="hrrr test: your new post executable did not generate bit-identical ${filein2} as the trunk"
  echo $msg
