...
if [ $err = "0" ] ; then
 ...
 export err1=$?
 if [ $err1 -eq 0 ] ; then
  msg="nmmb test: your new post executable generates bit-identical ${filein2} as the devlop"
  echo $msg
 else
  msg="nmmb test: your new post executable did not generate bit-identical ${filein2} as the devlop"
  echo $msg
