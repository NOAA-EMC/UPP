...
#PBS -o out.post.aigsf
#PBS -e out.post.aigsf
#PBS -N aigfs_test
#PBS -l walltime=00:30:00
#PBS -q debug
#PBS -A GFS-DEV
#PBS -l place=vscatter,select=3:ncpus=40
#PBS -V
...
export APRUN="mpiexec -l -n 120 -ppn 40"
...
if [ $err = "0" ] ; then
 ...
 cmp ${filein2} $homedir/data_out/aigfs/${filein2}.${machine}
 ...
 if [ $err1 -eq 0 ] ; then
  ...
  $cmp_grib2_grib2 $homedir/data_out/aigfs/${filein2}.${machine} ${filein2} > ${filein2}.diff
 fi
else
