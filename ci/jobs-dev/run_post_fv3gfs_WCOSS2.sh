...
if [ $err = "0" ] ; then
 ...
 export err1=$?
 if [ $err1 -eq 0 ] ; then
  msg="fv3gfs test: your new post executable generates bit-identical ${filein2} as the develop"
  echo $msg
 else
  msg="fv3gfs test: your new post executable did not generate bit-identical ${filein2} as the develop"
  echo $msg
