...
!jw
      ...
      real  AYEAR0,AMNTH0,ADAY0,AGMT0,TOTMIN,SGDG,GMAX,GMIN
...
!
!     DON'T SET PARAMETER IF PRECIP TYPE, SINCE THERE ARE
...
!         IGDS( 9) = CENLON
      ...
      ELSE IF(MAPTYPE.EQ.3)THEN  !Mercator
         ...
         IGDS(13) = TRUELAT1 
         IGDS(14) = 64 
      ELSE IF(MAPTYPE.EQ.0 .OR. MAPTYPE.EQ.203)THEN  !ARAKAWA STAGGERED E-GRID
         IGDS( 1) = 0
         IGDS( 2) = 255
         IGDS( 3) = 203 
         IGDS( 4) = IM
...
! INITPOST_GFS
      ELSE IF(MAPTYPE.EQ.4 .AND. IGDS(3)==0)THEN  !Gaussian grid
