...
contains
  ...
  subroutine test_twp_map(res)
    ...
    real :: exp_twp_out(ntests), twp_out
    integer :: i
    ...
    do i = 1, ntests
      twp_out = twp_map(v(i), scenario(i))
      if (abs(twp_out - exp_twp_out(i)) > tol) then
        print *, "twp_map() failed for test case ", i, ": expected ", exp_twp_out(i), &
              " but got ", twp_out
        res = 1
      end if
    end do
  ...
  subroutine test_t_map(res)
    ...
    real :: v(ntests)
    integer :: scenario(ntests)
    real :: exp_t_map_out(ntests), t_map_out
    integer :: i
  ...
  subroutine test_deltaZ_map(res)
    ...
    exp_deltaZ_map_out(30) = 0.0
    
    do i = 1, ntests
      deltaZ_map_out = deltaZ_map(v(i), scenario(i))
      if (abs(deltaZ_map_out - exp_deltaZ_map_out(i)) > tol) then
        print *, "deltaZ_map() failed for test case ", i, ": expected ", &
              exp_deltaZ_map_out(i), " but got ", deltaZ_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_ctt_map(res)
    ...
    real :: v(ntests)
    real :: exp_ctt_map_out(ntests), ctt_map_out
    integer :: i

    ! Test Case 1: v < 223.15
    v(1) = 200.0
    exp_ctt_map_out(1) = 0.8

    ! Test Case 2: v = 223.15
    v(2) = 223.15
    exp_ctt_map_out(2) = 0.8

    ! Test Case 3: 223.15 < v < 233.15
    v(3) = 230.0
    exp_ctt_map_out(3) = 0.762051

    ! Test Case 4: v = 233.15
    v(4) = 233.15
    exp_ctt_map_out(4) = 0.7446

    ! Test Case 5: 233.15 < v < 243.15
    v(5) = 240.0
    exp_ctt_map_out(5) = 0.630753

    ! Test Case 6: v = 243.15
    v(6) = 243.15
    exp_ctt_map_out(6) = 0.5784

    ! Test Case 7: 243.15 < v < 253.15
    v(7) = 250.0
    exp_ctt_map_out(7) = 0.388655

    ! Test Case 8: v = 253.15
    v(8) = 253.15
    exp_ctt_map_out(8) = 0.3014

    ! Test Case 9: 253.15 < v < 261.15
    v(9) = 255.0
    exp_ctt_map_out(9) = 0.23170125

    ! Test Case 10: v = 261.15
    v(10) = 261.15
    exp_ctt_map_out(10) = 0.0

    ! Test Case 11: v > 261.15
    v(11) = 270.0
    exp_ctt_map_out(11) = 0.0

    do i = 1, ntests
      ctt_map_out = ctt_map(v(i))
      if (abs(ctt_map_out - exp_ctt_map_out(i)) > tol) then
        print *, "ctt_map() failed for test case ", i, ": expected ", &
              exp_ctt_map_out(i), " but got ", ctt_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_vv_map(res)
    ...
    real :: v(ntests)
    real :: exp_vv_map_out(ntests), vv_map_out
    integer :: i

    ! Test Case 1: v < -0.5
    v(1) = -1.0
    exp_vv_map_out(1) = 1.0

    ! Test Case 2: v = -0.5
    v(2) = -0.5
    exp_vv_map_out(2) = 1.0

    ! Test Case 3: -0.5 < v < 0.0
    v(3) = -0.25
    exp_vv_map_out(3) = 0.5

    ! Test Case 4: v = 0.0
    v(4) = 0.0
    exp_vv_map_out(4) = 0.0

    ! Test Case 5: v > 0
    v(5) = 0.25
    exp_vv_map_out(5) = 0.0

    do i = 1, ntests
      vv_map_out = vv_map(v(i))
      if (abs(vv_map_out - exp_vv_map_out(i)) > tol) then
        print *, "vv_map() failed for test case ", i, ": expected ", &
              exp_vv_map_out(i), " but got ", vv_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_cldTopDist_map(res)
    ...
    integer, parameter :: ntests = 5
    real :: v(ntests)
    real :: exp_ctd_map_out(ntests), ctd_map_out
    integer :: i

    ! Test Case 1: v < 609.6
    v(1) = 500.0
    exp_ctd_map_out(1) = 1.0

    ! Test Case 2: v = 609.6
    v(2) = 609.6
    exp_ctd_map_out(2) = 1.0

    ! Test Case 3: 609.6 < v < 3048.0
    v(3) = 2072.64
    exp_ctd_map_out(3) = 0.4

    ! Test Case 4: v = 3048.0
    v(4) = 3048.0
    exp_ctd_map_out(4) = 0.0

    ! Test Case 5: v > 3048.0
    v(5) = 4000.0
    exp_ctd_map_out(5) = 0.0

    do i = 1, ntests
      ctd_map_out = cldTopDist_map(v(i))
      if (abs(ctd_map_out - exp_ctd_map_out(i)) > tol) then
        print *, "cldTopDist_map() failed for test case ", i, ": expected ", &
              exp_ctd_map_out(i), " but got ", ctd_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_cldBaseDist_map(res)
    ...
    integer, parameter :: ntests = 5
    real :: v(ntests)
    real :: exp_cbd_map_out(ntests), cbd_map_out
    integer :: i

    ! Test Case 1: v < 304.8
    v(1) = 200.0
    exp_cbd_map_out(1) = 1.0

    ! Test Case 2: v = 304.8
    v(2) = 304.8
    exp_cbd_map_out(2) = 1.0

    ! Test Case 3: 304.8 < v < 1524.0
    v(3) = 853.44
    exp_cbd_map_out(3) = 0.55

    ! Test Case 4: v = 1524.0
    v(4) = 1524.0
    exp_cbd_map_out(4) = 0.0

    ! Test Case 5: v > 1524.0
    v(5) = 2000.0
    exp_cbd_map_out(5) = 0.0

    do i = 1, ntests
      cbd_map_out = cldBaseDist_map(v(i))
      if (abs(cbd_map_out - exp_cbd_map_out(i)) > tol) then
        print *, "cldBaseDist_map() failed for test case ", i, ": expected ", &
              exp_cbd_map_out(i), " but got ", cbd_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_deltaQ_map(res)
    ...
    integer, parameter :: ntests = 5
    real :: v(ntests)
    real :: exp_deltaQ_map_out(ntests), deltaQ_map_out
    integer :: i

    ! Test Case 1: v < 0
    v(1) = -1.0
    exp_deltaQ_map_out(1) = 0.0

    ! Test Case 2: v = 0
    v(2) = 0.0
    exp_deltaQ_map_out(2) = 0.0

    ! Test Case 3: 0 < v < 1
    v(3) = 0.5
    exp_deltaQ_map_out(3) = 0.5

    ! Test Case 4: v = 1
    v(4) = 1.0
    exp_deltaQ_map_out(4) = 1.0

    ! Test Case 5: v > 1
    v(5) = 2.0
    exp_deltaQ_map_out(5) = 1.0

    do i = 1, ntests
      deltaQ_map_out = deltaQ_map(v(i))
      if (abs(deltaQ_map_out - exp_deltaQ_map_out(i)) > tol) then
        print *, "deltaQ_map() failed for test case ", i, ": expected ", &
              exp_deltaQ_map_out(i), " but got ", deltaQ_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_rh_map(res)
    ...
    integer, parameter :: ntests = 5
    real :: v(ntests)
    real :: exp_rh_map_out(ntests), rh_map_out
    integer :: i

    ! Test Case 1: v < 70
    v(1) = 50.0
    exp_rh_map_out(1) = 0.0

    ! Test Case 2: v = 70
    v(2) = 70.0
    exp_rh_map_out(2) = 0.0

    ! Test Case 3: 70 < v < 100
    v(3) = 85.0
    exp_rh_map_out(3) = 0.5

    ! Test Case 4: v = 100
    v(4) = 100.0
    exp_rh_map_out(4) = 1.0

    ! Test Case 5: v > 100
    v(5) = 150.0
    exp_rh_map_out(5) = 1.0

    do i = 1, ntests
      rh_map_out = rh_map(v(i))
      if (abs(rh_map_out - exp_rh_map_out(i)) > tol) then
        print *, "rh_map() failed for test case ", i, ": expected ", &
              exp_rh_map_out(i), " but got ", rh_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_condensate_map(res)
    ...
    integer, parameter :: ntests = 5
    real :: v(ntests)
    real :: exp_con_map_out(ntests), con_map_out
    integer :: i

    ! Test Case 1: v < 0.004
    v(1) = 0.002
    exp_con_map_out(1) = 0.0

    ! Test Case 2: v = 0.004
    v(2) = 0.004
    exp_con_map_out(2) = 0.0

    ! Test Case 3: 0.004 < v < 0.2
    v(3) = 0.0824
    exp_con_map_out(3) = 0.4

    ! Test Case 4: v = 0.2
    v(4) = 0.2
    exp_con_map_out(4) = 1.0

    ! Test Case 5: v > 0.2
    v(5) = 0.3
    exp_con_map_out(5) = 1.0

    do i = 1, ntests
      con_map_out = condensate_map(v(i))
      if (abs(con_map_out - exp_con_map_out(i)) > tol) then
        print *, "condensate_map() failed for test case ", i, ": expected ", &
              exp_con_map_out(i), " but got ", con_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_convect_t_map(res)
    ...
    real :: v(ntests)
    real :: exp_cnv_t_map_out(ntests), cnv_t_map_out
    integer :: i

    ! Test Case 1: v < 243.15
    v(1) = 200.0
    exp_cnv_t_map_out(1) = 0.0

    ! Test Case 2: v = 243.15
    v(2) = 243.15
    exp_cnv_t_map_out(2) = 0.0

    ! Test Case 3: 243.15 < v < 265.15
    v(3) = 254.15
    exp_cnv_t_map_out(3) = 0.5

    ! Test Case 4: v = 265.15
    v(4) = 265.15
    exp_cnv_t_map_out(4) = 1.0

    ! Test Case 5: 265.15 < v < 269.15
    v(5) = 267.15
    exp_cnv_t_map_out(5) = 1.0

    ! Test Case 6: v = 269.15
    v(6) = 269.15
    exp_cnv_t_map_out(6) = 1.0

    ! Test Case 7: 269.15 < v < 270.15
    v(7) = 269.5
    exp_cnv_t_map_out(7) = 0.9545

    ! Test Case 8: v = 270.15
    v(8) = 270.15
    exp_cnv_t_map_out(8) = 0.87

    ! Test Case 9: 270.15 < v < 271.15
    v(9) = 271.0
    exp_cnv_t_map_out(9) = 0.734

    ! Test Case 10: v = 271.15
    v(10) = 271.15
    exp_cnv_t_map_out(10) = 0.71

    ! Test Case 11: 271.15 < v < 272.15
    v(11) = 272.0
    exp_cnv_t_map_out(11) = 0.5315

    ! Test Case 12: v = 272.15
    v(12) = 272.15
    exp_cnv_t_map_out(12) = 0.5

    ! Test Case 13: 272.15 < v < 273.15
    v(13) = 272.5
    exp_cnv_t_map_out(13) = 0.325

    ! Test Case 14: v = 273.15
    v(14) = 273.15
    exp_cnv_t_map_out(14) = 0.0

    ! Test Case 15: v > 273.15
    v(15) = 274.0
    exp_cnv_t_map_out(15) = 0.0

    do i = 1, ntests
      cnv_t_map_out = convect_t_map(v(i))
      if (abs(cnv_t_map_out - exp_cnv_t_map_out(i)) > tol) then
        print *, "convect_t_map() failed for test case ", i, ": expected ", &
              exp_cnv_t_map_out(i), " but got ", cnv_t_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_convect_qpf_map(res)
    ...
    integer, parameter :: ntests = 5
    real :: v(ntests)
    real :: exp_cnv_qpf_map_out(ntests), cnv_qpf_map_out
    integer :: i

    ! Test Case 1: v < 1
    v(1) = 0.5
    exp_cnv_qpf_map_out(1) = 0.0

    ! Test Case 2: v = 1
    v(2) = 1.0
    exp_cnv_qpf_map_out(2) = 0.0

    ! Test Case 3: 1 < v < 3
    v(3) = 1.5
    exp_cnv_qpf_map_out(3) = 0.25

    ! Test Case 4: v = 3
    v(4) = 3.0
    exp_cnv_qpf_map_out(4) = 1.0

    ! Test Case 5: v > 3
    v(5) = 4.0
    exp_cnv_qpf_map_out(5) = 1.0

    do i = 1, ntests
      cnv_qpf_map_out = convect_qpf_map(v(i))
      if (abs(cnv_qpf_map_out - exp_cnv_qpf_map_out(i)) > tol) then
        print *, "convect_qpf_map() failed for test case ", i, ": expected ", &
              exp_cnv_qpf_map_out(i), " but got ", cnv_qpf_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_convect_cape_map(res)
    ...
    integer, parameter :: ntests = 5
    real :: v(ntests)
    real :: exp_cnv_cape_map_out(ntests), cnv_cape_map_out
    integer :: i

    ! Test Case 1: v < 1000
    v(1) = 500
    exp_cnv_cape_map_out(1) = 0.0

    ! Test Case 2: v = 1000
    v(2) = 1000
    exp_cnv_cape_map_out(2) = 0.0

    ! Test Case 3: 1000 < v < 2500
    v(3) = 2200
    exp_cnv_cape_map_out(3) = 0.8

    ! Test Case 4: v = 2500
    v(4) = 2500
    exp_cnv_cape_map_out(4) = 1.0

    ! Test Case 5: v > 2500
    v(5) = 3000
    exp_cnv_cape_map_out(5) = 1.0

    do i = 1, ntests
      cnv_cape_map_out = convect_cape_map(v(i))
      if (abs(cnv_cape_map_out - exp_cnv_cape_map_out(i)) > tol) then
        print *, "convect_cape_map() failed for test case ", i, ": expected ", &
              exp_cnv_cape_map_out(i), " but got ", cnv_cape_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_convect_liftedIdx_map(res)
    ...
    integer, parameter :: ntests = 5
    real :: v(ntests)
    real :: exp_cnv_liftedIdx_map_out(ntests), cnv_liftedIdx_map_out
    integer :: i

    ! Test Case 1: v < -10
    v(1) = -15
    exp_cnv_liftedIdx_map_out(1) = 1.0

    ! Test Case 2: v = -10
    v(2) = -10
    exp_cnv_liftedIdx_map_out(2) = 1.0

    ! Test Case 3: -10 < v < 0
    v(3) = -5
    exp_cnv_liftedIdx_map_out(3) = 0.5

    ! Test Case 4: v = 0
    v(4) = 0
    exp_cnv_liftedIdx_map_out(4) = 0.0

    ! Test Case 5: v > 0
    v(5) = 1
    exp_cnv_liftedIdx_map_out(5) = 0.0

    do i = 1, ntests
      cnv_liftedIdx_map_out = convect_liftedIdx_map(v(i))
      if (abs(cnv_liftedIdx_map_out - exp_cnv_liftedIdx_map_out(i)) > tol) then
        print *, "convect_liftedIdx_map() failed for test case ", i, ": expected ", &
              exp_cnv_liftedIdx_map_out(i), " but got ", cnv_liftedIdx_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_convect_kIdx_map(res)
    ...
    integer, parameter :: ntests = 5
    real :: v(ntests)
    real :: exp_cnv_kIdx_map_out(ntests), cnv_kIdx_map_out
    integer :: i

    ! Test Case 1: v < 20
    v(1) = 10
    exp_cnv_kIdx_map_out(1) = 0.0

    ! Test Case 2: v = 20
    v(2) = 20
    exp_cnv_kIdx_map_out(2) = 0.0

    ! Test Case 3: 20 < v < 40
    v(3) = 30
    exp_cnv_kIdx_map_out(3) = 0.5

    ! Test Case 4: v = 40
    v(4) = 40
    exp_cnv_kIdx_map_out(4) = 1.0

    ! Test Case 5: v > 40
    v(5) = 50
    exp_cnv_kIdx_map_out(5) = 1.0

    do i = 1, ntests
      cnv_kIdx_map_out = convect_kIdx_map(v(i))
      if (abs(cnv_kIdx_map_out - exp_cnv_kIdx_map_out(i)) > tol) then
        print *, "convect_kIdx_map() failed for test case ", i, ": expected ", &
              exp_cnv_kIdx_map_out(i), " but got ", cnv_kIdx_map_out
        res = 1
      end if
    end do
  ...
  subroutine test_convect_totals_map(res)
    ...
    integer, parameter :: ntests = 5
    real :: v(ntests)
    real :: exp_cnv_totals_map_out(ntests), cnv_totals_map_out
    integer :: i

    ! Test Case 1: v < 20
    v(1) = 10
    exp_cnv_totals_map_out(1) = 0.0

    ! Test Case 2: v = 20
    v(2) = 20
    exp_cnv_totals_map_out(2) = 0.0

    ! Test Case 3: 20 < v < 55
    v(3) = 34
    exp_cnv_totals_map_out(3) = 0.4

    ! Test Case 4: v = 55
    v(4) = 55
    exp_cnv_totals_map_out(4) = 1.0

    ! Test Case 5: v > 55
    v(5) = 60
    exp_cnv_totals_map_out(5) = 1.0

    do i = 1, ntests
      cnv_totals_map_out = convect_totals_map(v(i))
      if (abs(cnv_totals_map_out - exp_cnv_totals_map_out(i)) > tol) then
        print *, "convect_totals_map() failed for test case ", i, ": expected ", &
              exp_cnv_totals_map_out(i), " but got ", cnv_totals_map_out
        res = 1
      end if
    end do
