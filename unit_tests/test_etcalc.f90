...
program test_etcalc
    ...
    EXP_SMCDRY = reshape([0.023, 0.028, 0.047, 0.084, 0.084, 0.066, &
                        0.069, 0.120, 0.103, 0.100, 0.126, 0.135, &
                        0.069, 0.000, 0.012, 0.028, 0.135, 0.012, &
                        0.023, 0.023, 0.023, 0.023, 0.023, 0.023], [ntests])

    EXP_SMCMAX = reshape([0.395, 0.421, 0.434, 0.476, 0.476, 0.439, &
                        0.404, 0.464, 0.465, 0.406, 0.468, 0.457, &
                        0.464, 0.000, 0.200, 0.421, 0.457, 0.200, &
                        0.395, 0.395, 0.395, 0.395, 0.395, 0.395], [ntests])

    EXP_EDIR = reshape([1.1655249596E+01, 9.6368389130E+00, 7.0835776329E+00, &
                        ...
                        0.0000000000E+00, 1.1655249596E+01, 1.1655249596E+01], [ntests])

    EXP_ETRANS = reshape([6.7634078979E+01, 6.9652481079E+01, 7.2205749512E+01, &
                          ...
                          7.9289321899E+01, 3.8344757080E+01, 0.0000000000E+00], [ntests])
