...
program test_upp_physics
    ...
    T_FPVS(1) = 200.0
    EXP_SVP(1) = 0.0 ! TODO: Set exp value

    ! Test Case 2: x == tice
    T_FPVS(2) = 253.16
    EXP_SVP(2) = 0.0 ! TODO: Set exp value

    ! Test Case 3: tice < x, xp1 < tliq
    T_FPVS(3) = 270.0
    EXP_SVP(3) = 0.0 ! TODO: Set exp value

    ! Test Case 4: x == tliq
    T_FPVS(4) = 273.16
    EXP_SVP(4) = 0.0 ! TODO: Set exp value

    ! Test Case 5: x, xp1 > tliq
    T_FPVS(5) = 290.0
    EXP_SVP(5) = 0.0 ! TODO: Set exp value
