...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  subroutine p2th(km,theta,u,v,h,t,pvu,sigma,q,p,kth,th &
,lth,uth,vth,hth,tth,zth,sigmath,qth,pth)
!$$$  Subprogram documentation block
!
...
!$$$
    ...
    real,intent(in),dimension(km):: theta,u,v,h,t,pvu,sigma,q,p
