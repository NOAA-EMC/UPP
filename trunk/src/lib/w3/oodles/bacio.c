...
/*  This was modified by C. Harrop on Feb 7, 2006
    An extra character must be alloated because all C strings
    must have a NULL terminator
    realname = (char *) malloc( namelen * sizeof(char) ) ;
*/
    realname = (char *) malloc( namelen * sizeof(char) + 1 ) ;
...
/* This section of code was rewritten by C. Harrop on Feb 7 2006 
