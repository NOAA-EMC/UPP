...
!=============================================================================
! tms - SLOVACEK
! moved this from GSI source directory to handle the absense of ESSL libraries
! on the 1 machines :: requires a changes to the calling routine based
! on the ibm_sp preprocessor flag
!=============================================================================
!
