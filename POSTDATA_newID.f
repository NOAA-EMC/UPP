...
C
      DATA SPVAL/9.9e10/
C
C  LIST OF PRESSURE LEVELS AVAILABLE FOR OUTPUT
C
!      DATA SPL/100.,200.,300.,500.,700.,1000.,2000.,3000.
...
C
C	IFILV IS FLAG FOR IDENTIFYING MASS OR VELOCITY POINT
C	   =0 DATA IS VELOCITY POINT
C	   =1 DATA IS MASS POINT
...
C       (3) INCREASE PARAMETER MXFLD IN COMMON BLOCK RQSTFLD.comm.
C
