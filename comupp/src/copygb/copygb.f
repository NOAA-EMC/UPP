...
C 2011-02-25  HALLEYGOTWAY ADDED SUPPORT FOR EXTENDED PDS
C
...
C$$$
      ...
      INTEGER IDS(255),IBS(255),NBS(255)
      INTEGER JPDS(200),JGDS(200),JENS(5)
      INTEGER KPDS1(200),KPDSB(200),KPDSM(200)
      INTEGER KGDS1(200),KGDSB(200),KGDSM(200)
      INTEGER KENS1(5),KENSB(5),KENSM(5)
      INTEGER KPROB1(2),KPROBB(2),KPROBM(2)
      REAL    XPROB1(2),XPROBB(2),XPROBM(2)
      INTEGER KCLUST1(16),KCLUSTB(16),KCLUSTM(16)
      INTEGER KMEMBR1(80),KMEMBRB(80),KMEMBRM(80)
...
C  GET FIELD FROM FILE 1
      ...
      KPDS1=0
      KGDS1=0
      CALL GETGBEXM(LG1,LX1,M1,KS1,JPDS1,JGDS,JENS,
     &              MBUF,CBUF1,NLEN1,NNUM1,MNUM1,
     &              K1,KR1,KPDS1,KGDS1,KENS1,
     &              KPROB1,XPROB1,KCLUST1,KMEMBR1,
     &              LR,FR,IRET)
     ...
     &          KPDS1(5).NE.IUV(JUV)+1)
        ...
        IF(JUV.LE.NUV.AND.KPDS1(5).EQ.IUV(JUV)) THEN
          ...
          JGDS=KGDS1
          JENS=KENS1
          CALL GETGBEXM(LG1,LX1,M1,KRV,JPDS,JGDS,JENS,
     &                  MBUF,CBUF1,NLEN1,NNUM1,MNUM1,
     &                  K1,KRVX,KPDS1,KGDS1,KENS1,
     &                  KPROB1,XPROB1,KCLUST1,KMEMBR1,
     &                  LR,GR,IRET)
...
C  GET MAP FIELD
      IF(IRET.EQ.0.AND.JB.EQ.4) THEN
        ...
        JGDS=-1
        JENS=-1
        CALL GETGBEXM(LGB,LXB,MB,KRB,JPDSB,JGDS,JENS,
     &                MBUF,CBUFB,NLENB,NNUMB,MNUMB,
     &                KB,KRBX,KPDSB,KGDSB,KENSB,
     &                KPROBB,XPROBB,KCLUSTB,KMEMBRB,
     &                LR,FR,IRET)
...
C  MERGE FIELD
        IF(LAM.EQ.5.AND.IB1I.EQ.1) THEN
          ...
          JGDS=-1
          JENS=-1
          CALL GETGBEXM(LGM,LXM,MM,KRM,JPDS,JGDS,JENS,
     &                  MBUF,CBUFM,NLENM,NNUMM,MNUMM,
     &                  KM,KRMX,KPDSM,KGDSM,KENSM,
     &                  KPROBM,XPROBM,KCLUSTM,KMEMBRM,
     &                  LR,FR,IRET)
...
C  WRITE OUTPUT FIELD
      IF(IRET.EQ.0) THEN
        ...
        ENDIF
        KPDS1(22)=IDS1
        CALL PUTGBEX(LG2,MI,KPDS1,KGDSI,KENS1,
     &               KPROB1,XPROB1,KCLUST1,KMEMBR1,
     &               L1I,F1I,IRET)
