...
C 2010-01-20  GAYNO       ADDED ROTATED LAT/LON "A,B,C,D" STAGGERS -> KGDS(1) 205
C
...
C   95-10-31  IREDELL     REMOVED SAVES AND PRINTS
C   98-09-08  BALDWIN     ADD DATA REP TYPE [KGDS(1)] 203
C   10-01-20  GAYNO       ADD DATA REP TYPE [KGDS(1)] 205
C                        
C
...
C     ELSE IF (KGDS(1).EQ.80) THEN
      ELSE IF (KGDS(1).EQ.201.OR.KGDS(1).EQ.202.OR.KGDS(1).EQ.203
     &.OR.KGDS(1).EQ.205) THEN
          GO TO 1000
      ELSE
...
C                 ----- U.S. GRID 170 - MAP SIZE 4147200
                  J     = 4147200
                  GO TO 800
...
C                     ----- U.S. NON-STANDARD GRID
          ...
          ELSE IF (KPDS(3).GE.200) THEN
              ...
              ELSE IF (KPDS(3).EQ.163) THEN
                  J = 727776
                  GO TO 800
              ELSE IF (KPDS(3).EQ.164) THEN
                  J = 105280
                  GO TO 800
              ELSE IF (KPDS(3).EQ.165) THEN
                  J = 47040
                  GO TO 800
              ELSE IF (KPDS(3).EQ.166) THEN
                  J = 58240
                  GO TO 800
              ELSE IF (IAND(KPDS(4),128).EQ.128) THEN
                  GO TO 895
      ...
      ELSE IF (KPDS(1).EQ.7) THEN
          ...
          ELSE IF (KPDS(3).EQ.126.OR.KPDS(3).EQ.127) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE IF (KPDS(3).EQ.145.OR.KPDS(3).EQ.146) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE IF (KPDS(3).GE.170.AND.KPDS(3).LE.172) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE IF (KPDS(3).EQ.175) THEN
          ...
          ELSE IF (KPDS(3).EQ.198) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE IF (KPDS(3).GE.201.AND.KPDS(3).LE.253) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE
