...
C
C SUBPROGRAM:  SPTRANF0   SPTRANF SPECTRAL INITIALIZATION
C   PRGMMR: IREDELL       ORG: W/NMC23       DATE: 96-02-29
C
C ABSTRACT: THIS SUBPROGRAM PERFORMS AN INITIALIZATION FOR
...
C
C USAGE:    CALL SPTRANF0(IROMB,MAXWV,IDRT,IMAX,JMAX,JB,JE,
C    &                    EPS,EPSTOP,ENN1,ELONN1,EON,EONTOP,
C    &                    AFFT,CLAT,SLAT,WLAT,PLN,PLNTOP)
C   INPUT ARGUMENTS:
...
C     PLN      - REAL ((MAXWV+1)*((IROMB+1)*MAXWV+2)/2,JB:JE)
C                LEGENDRE POLYNOMIALS
C     PLNTOP   - REAL (MAXWV+1,JB:JE) LEGENDRE POLYNOMIAL OVER TOP
C
