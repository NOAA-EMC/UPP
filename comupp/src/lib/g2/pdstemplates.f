...
!$$$
      ...
      integer,parameter :: MAXLEN=200,MAXTEMP=47
...
!    PDT 4.54  (07/30/2013)
!
      data templates(43)%template_num /54/     !  Individual ensemble forecast, control and perturbed,
...
!    PDT 4.57  (10/07/2015)
!
      data templates(44)%template_num /57/     !  Analysis or Forecast at a horizontal or in a 
...
!
     ...
     &  /1,1,1,1,1,2,1,1,-4,1,-1,-4,1,-1,-4,1,1,1,2,1,1,1,1,1,2,1,1,1,
     &   1,1,1,4,1,1,1,4,1,4/
!
!    PDT 4.35  (10/07/2015)   for Validation (OPC)
!
      data templates(47)%template_num /35/     !  Satellite Product with or without
      data templates(47)%mappdslen /6/         !  associated quality values
